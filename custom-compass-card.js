          ...
          <div class="compass-circle">
            ${e.background_image_show&&this._backgroundImageUrl?html`
              <img class="compass-bg-image"
                ...
                style="transform: translate(${e.background_image_x}%, ${e.background_image_y}%) rotate(${e.background_image_rotate}deg) scale(${e.background_image_scale/100});"
              />
            `:""}
          ...
          <div class="compass-needle-wrapper" style="transform:${t}">
            ${e.needle_show?html`
              <svg class="compass-needle"
                ...
                <path d="${r.path}" fill="url(#needleGradient)" />
              </svg>
            `:""}
          </div>
        </div>
