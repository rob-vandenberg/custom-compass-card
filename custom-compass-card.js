import{LitElement,html,svg,css}from"https://unpkg.com/lit@2.0.0/index.js?module";const CARD_VERSION="3.7.144",DEFAULT_CONFIG={background_color:"#101010",bezel_color:"#383838",bezel_width:16,bezel_size:0,background_image_show:!0,background_image_url:"/local/community/custom-compass-card/black.png",background_image_scale:100,background_image_x:0,background_image_y:0,background_image_rotate:0,needle_show:!0,needle_template:"{{ state_attr('sun.sun', 'azimuth') | float(0) }}",needle_invert:!1,needle_rotate:!1,needle_color_1:"#FF0000",needle_color_1_pos:50,needle_color_2:"#EEEEEE",needle_color_2_pos:50,needle_height:100,needle_width:10,needle_position:-10,needle_morph:50,needle_curve:0,needle_image_show:!1,needle_image_url:"/local/community/custom-compass-card/moon.png",needle_image_scale:100,needle_image_x:0,needle_image_y:0,needle_image_rotate:0,compass_rotate:!1,marker_1_show:!1,marker_1_degrees:"45",marker_1_length:5,marker_1_width:4,marker_1_position:0,marker_1_color:"#FF0000",marker_2_show:!1,marker_2_degrees:"315",marker_2_length:5,marker_2_width:4,marker_2_position:0,marker_2_color:"#2196F3",cardinals_show:!0,cardinal_north:"N",cardinal_east:"E",cardinal_south:"S",cardinal_west:"W",cardinals_fontsize:10,cardinals_fontweight:400,cardinals_position:1.5,cardinals_fontcolor:"#EEEEEE",major_ticks_show:!1,major_ticks_length:6,major_ticks_width:2,major_ticks_position:-3.5,major_ticks_color:"#CCCCCC",minor_ticks_show:!0,minor_ticks_length:3,minor_ticks_width:1.5,minor_ticks_position:-4.5,minor_ticks_color:"#AAAAAA",micro_ticks_show:!0,micro_ticks_length:0,micro_ticks_width:2,micro_ticks_position:-6.5,micro_ticks_color:"#888888",header_show:!1,header_text:"header",header_fontsize:2,header_fontweight:400,header_position:0,header_fontcolor:"#FFFFFF",footer_show:!1,footer_text:"footer",footer_fontsize:2,footer_fontweight:400,footer_position:0,footer_fontcolor:"#FFFFFF",field_1_show:!0,field_1_template:"${compass_direction}",field_1_fontsize:1.5,field_1_fontweight:400,field_1_position:23,field_1_fontcolor:"#29B6CF",field_1_unit:"",field_1_unit_fontsize:1,field_1_unit_fontweight:400,field_1_unit_fontcolor:"#196D7C",field_2_show:!1,field_2_template:"{{ states('sensor.ws_wind_speed') | round(1) }}",field_2_unit:"km/h",field_2_fontsize:2,field_2_fontweight:400,field_2_position:50,field_2_fontcolor:"#E8E8E8",field_2_unit_fontsize:1.2,field_2_unit_fontweight:400,field_2_unit_fontcolor:"#8C8C8C",field_3_show:!0,field_3_template:"{{ state_attr('sun.sun', 'azimuth') | round(0) }}",field_3_unit:"°",field_3_fontsize:1.4,field_3_fontweight:400,field_3_position:79,field_3_fontcolor:"#808080",field_3_unit_fontsize:1.4,field_3_unit_fontweight:400,field_3_unit_fontcolor:"#606060",rotation_animation_time:.5};class CcTextfield extends LitElement{static properties={value:{type:String},type:{type:String},step:{type:String},min:{type:String},max:{type:String}};static styles=css`
  ...
  `;render(){return html`
      <input
        ...
        @input=${this._onInput}
      />
    `}_onInput(e){this.value=e.target.value,this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}}customElements.define("cc-textfield",CcTextfield);class CustomCompassCardEditor extends LitElement{static properties={hass:{type:Object},_config:{type:Object}};setConfig(e){this._config={...DEFAULT_CONFIG,...e}}_valueChanged(e,t){if(!this._config||!this.hass)return;let i;i=void 0!==t.detail?.value?t.detail.value:"HA-SWITCH"===t.target.tagName?t.target.checked:t.target.value,"number"===t.target.type&&(i=parseFloat(i),isNaN(i))||(this._config={...this._config,[e]:i},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0})))}_colorPicker(e,t){const i=this._config[e]||"#ffffff";return html`
  ...
  `}customElements.define("custom-compass-card-editor",CustomCompassCardEditor);class CustomCompassCard extends LitElement{static properties={hass:{type:Object},config:{type:Object},_degrees:{type:Number},_field1Value:{type:String},_field2Value:{type:String},_field3Value:{type:String},_headerValue:{type:String},_footerValue:{type:String},_marker1Degrees:{type:Number},_marker2Degrees:{type:Number},_backgroundImageUrl:{type:String},_needleImageUrl:{type:String},_error:{type:Boolean}};constructor(){super(),this._degrees=0,this._prevDegrees=null,this._templateUnsubs=[],this._subscriptionsActive=!1,this._field1Value="",this._field2Value="",this._field3Value="",this._headerValue="",this._footerValue="",this._marker1Degrees=0,this._marker2Degrees=0,this._backgroundImageUrl="",this._needleImageUrl="",this._error=!1}setConfig(e){this.config={...DEFAULT_CONFIG,...e}}connectedCallback(){super.connectedCallback(),this.hass&&this.config&&!this._subscriptionsActive&&this._setupSubscriptions()}disconnectedCallback(){super.disconnectedCallback(),this._teardownSubscriptions()}updated(e){super.updated(e),this._scaleElements(),this.hass&&this.config&&(this._subscriptionsActive&&!e.has("config")||this._setupSubscriptions())}_setupSubscriptions(){if(this._teardownSubscriptions(),!this.hass?.connection||!this.config)return;this._subscriptionsActive=!0;const e=(e,t)=>{const i=String(e);if(!i.includes("{{"))return void t(i);const l=this.hass.connection.subscribeMessage(e=>t(e.result),{type:"render_template",template:i});this._templateUnsubs.push(l)};e(this.config.needle_template,e=>{const t=parseFloat(e);if(isNaN(t))this._degrees=0,this._prevDegrees=null,this._error=!0;else{const e=(t%360+360)%360;if(e!==this._prevDegrees){let t=e-(this._degrees%360+360)%360;t>180&&(t-=360),t<-180&&(t+=360),this._degrees=this._degrees+t,this._prevDegrees=e}this._error=!1}this._updateCompassDirectionFields()});for(const t of this._fieldDefs){if(!t.show){this[`_field${t.index}Value`]="";continue}const i=t.index;e(String(t.template),e=>{this[`_field${i}Value`]=String(e).replace("${compass_direction}",this.getCompassDirection(this._degrees))})}this.config.header_show&&this.config.header_text?e(this.config.header_text,e=>{this._headerValue=e}):this._headerValue="",this.config.footer_show&&this.config.footer_text?e(this.config.footer_text,e=>{this._footerValue=e}):this._footerValue="";for(const t of[{key:"marker_1_degrees",prop:"_marker1Degrees"},{key:"marker_2_degrees",prop:"_marker2Degrees"}])e(this.config[t.key],e=>{this[t.prop]=(parseFloat(e)%360+360)%360});this.config.background_image_show?e(this.config.background_image_url,e=>{this._backgroundImageUrl=e}):this._backgroundImageUrl="",this.config.needle_image_show?e(this.config.needle_image_url,e=>{this._needleImageUrl=e}):this._needleImageUrl=""}_updateCompassDirectionFields(){const e=this.getCompassDirection(this._degrees);for(const t of this._fieldDefs){if(!t.show)continue;const i=String(t.template);i.includes("${compass_direction}")&&(i.includes("{{")||(this[`_field${t.index}Value`]=i.replace("${compass_direction}",e)))}}get _fieldDefs(){return[{index:1,show:this.config.field_1_show,template:this.config.field_1_template},{index:2,show:this.config.field_2_show,template:this.config.field_2_template},{index:3,show:this.config.field_3_show,template:this.config.field_3_template}]}_teardownSubscriptions(){const e=this._templateUnsubs;this._templateUnsubs=[],this._subscriptionsActive=!1;for(const t of e)Promise.resolve(t).then(e=>e()).catch(()=>{})}_scaleElements(){const e=this.shadowRoot.querySelector(".compass-circle");if(!e)return;const t=e.offsetWidth,i=t/120;this.style.setProperty("--cc-font-size",.08*t+"px");const l=parseFloat(this.config.bezel_width),a=parseFloat(this.config.bezel_size);this.style.setProperty("--cc-circle-border-width",l*i+"px"),this.style.setProperty("--cc-circle-color",this.config.bezel_color),this.style.setProperty("--cc-bg-color",this.config.background_color),this.style.setProperty("--cc-border-size",`${a}px`);const s=parseFloat(this.config.needle_width),o=parseFloat(this.config.needle_height),n=parseFloat(this.config.needle_position);this.style.setProperty("--cc-needle-width",s*i+"px"),this.style.setProperty("--cc-needle-height",o*i+"px"),this.style.setProperty("--cc-needle-position",n*i+"px"),this.style.setProperty("--cc-animation-duration",`${this.config.rotation_animation_time}s`);const d=this.shadowRoot.querySelector(".compass-ticks-wrapper");d&&this.style.setProperty("--cc-circle-size",`${d.offsetWidth}px`)}getCompassDirection(e){const t=(e%360+360)%360,i=this.config.cardinal_north,l=this.config.cardinal_east,a=this.config.cardinal_south,s=this.config.cardinal_west;return[i,i+i+l,i+l,l+i+l,l,l+a+l,a+l,a+a+l,a,a+a+s,a+s,s+a+s,s,s+i+s,i+s,i+i+s][Math.floor((t+11.25)/22.5)%16]}_buildNeedlePath(e,t,i,l){let a=[{x:50,y:0},{x:0,y:50},{x:50,y:50+e},{x:100,y:50}];const s=Math.abs(e)/50,o=Math.sign(e)*Math.min(1,Math.abs(e)/50)*(Math.PI/2);let n=[{in:{x:1,y:0},out:{x:-1,y:0},lengthMultiplier:1},{in:{x:0,y:-1},out:{x:Math.cos(o),y:Math.sin(o)},lengthMultiplier:1},{in:{x:-1,y:0},out:{x:1,y:0},lengthMultiplier:s},{in:{x:-Math.cos(o),y:Math.sin(o)},out:{x:0,y:-1},lengthMultiplier:1}];i&&(a.forEach(e=>{e.y=-e.y}),n.forEach(e=>{e.in.y=-e.in.y,e.out.y=-e.out.y}));const d=a.map((e,i)=>{const l=t*n[i].lengthMultiplier;return{in:{x:e.x+n[i].in.x*l,y:e.y+n[i].in.y*l},out:{x:e.x+n[i].out.x*l,y:e.y+n[i].out.y*l}}}),r=[...a];d.forEach(e=>r.push(e.in,e.out));const c=-Math.min(...r.map(e=>e.y))+l;a.forEach(e=>{e.y+=c}),d.forEach(e=>{e.in.y+=c,e.out.y+=c});let _=`M ${a[0].x},${a[0].y}`;for(let e=0;e<a.length;e++){const t=(e+1)%a.length;_+=` C ${d[e].out.x},${d[e].out.y} ${d[t].in.x},${d[t].in.y} ${a[t].x},${a[t].y}`}_+=" Z";const h=[...a];d.forEach(e=>h.push(e.in,e.out));const g=h.map(e=>e.x),p=h.map(e=>e.y);return{path:_.trim().replace(/\s+/g," "),bounds:{minX:Math.min(...g),maxX:Math.max(...g),minY:Math.min(...p),maxY:Math.max(...p)}}}_renderTicks(e="none"){const t=this.config,i=50,l=[t.cardinal_north,t.cardinal_east,t.cardinal_south,t.cardinal_west],a=[0,4,8,12],s={major:{show:t.major_ticks_show,length:t.major_ticks_length,width:t.major_ticks_width,color:t.major_ticks_color,position:t.major_ticks_position||0,cardinals:t.cardinals_show,cardinal_color:t.cardinals_fontcolor,cardinal_fontsize:t.cardinals_fontsize,cardinal_fontweight:t.cardinals_fontweight,cardinal_position:t.cardinals_position||0},minor:{show:t.minor_ticks_show,length:t.minor_ticks_length,width:t.minor_ticks_width,color:t.minor_ticks_color,position:t.minor_ticks_position||0,cardinals:!1},micro:{show:t.micro_ticks_show,length:t.micro_ticks_length,width:t.micro_ticks_width,color:t.micro_ticks_color,position:t.micro_ticks_position||0,cardinals:!1}},o=Array.from({length:16},(e,t)=>{const o=s[t%4==0?"major":t%2==0?"minor":"micro"],n=o.show,d=parseFloat(o.length),r=parseFloat(o.width),c=o.color,_=parseFloat(o.position),h=22.5*t*Math.PI/180,g=Math.sin(h),p=Math.cos(h);if(o.cardinals){const e=a.indexOf(t),s=l[e],n=50+(i+o.cardinal_position)*g,d=50-(i+o.cardinal_position)*p,r=.85*o.cardinal_fontsize;return{show:!0,type:"text",x:n-r*g,y:d+r*p,letter:s,fontSize:o.cardinal_fontsize,fontWeight:o.cardinal_fontweight,color:o.cardinal_color}}return{show:n,type:"line",x1:50+(i+_)*g,y1:50-(i+_)*p,x2:50+(i+_-d)*g,y2:50-(i+_-d)*p,color:c,width:r}}),n=[{show:t.marker_1_show,degrees:this._marker1Degrees,length:parseFloat(t.marker_1_length),width:parseFloat(t.marker_1_width),position:parseFloat(t.marker_1_position),color:t.marker_1_color},{show:t.marker_2_show,degrees:this._marker2Degrees,length:parseFloat(t.marker_2_length),width:parseFloat(t.marker_2_width),position:parseFloat(t.marker_2_position),color:t.marker_2_color}].map(e=>{if(!e.show)return null;const t=e.degrees*Math.PI/180,l=Math.sin(t),a=Math.cos(t),s=i+e.position,o=50+s*l,n=50-s*a,d=s+e.length,r=50+d*l,c=50-d*a,_=e.width/2,h=r+_*a,g=c+_*l,p=r-_*a,f=c-_*l;return{color:e.color,path:`M ${o},${n} L ${h},${g} L ${p},${f} Z`}}).filter(Boolean);return html`
    ...
    `}_fieldStyle(e){return`font-size:${e.fontsize}em; font-weight:${e.fontweight}; color:${e.fontcolor}; top:${e.position}%;`}_unitStyle(e){return`font-size:${e.unit_fontsize/e.fontsize}em; font-weight:${e.unit_fontweight}; color:${e.unit_fontcolor};`}render(){const e=this.config||{};let t,i;e.compass_rotate?(i=`rotate(${-this._degrees}deg)`,t=`rotate(${e.needle_rotate?180:0}deg)`):(i="none",t=`rotate(${e.needle_rotate?this._degrees+180:this._degrees}deg)`);const l=[{index:1,show:e.field_1_show,unit:e.field_1_unit,fontsize:parseFloat(e.field_1_fontsize),fontweight:e.field_1_fontweight,position:e.field_1_position,fontcolor:e.field_1_fontcolor,unit_fontsize:parseFloat(e.field_1_unit_fontsize),unit_fontweight:e.field_1_unit_fontweight,unit_fontcolor:e.field_1_unit_fontcolor},{index:2,show:e.field_2_show,unit:e.field_2_unit,fontsize:parseFloat(e.field_2_fontsize),fontweight:e.field_2_fontweight,position:e.field_2_position,fontcolor:e.field_2_fontcolor,unit_fontsize:parseFloat(e.field_2_unit_fontsize),unit_fontweight:e.field_2_unit_fontweight,unit_fontcolor:e.field_2_unit_fontcolor},{index:3,show:e.field_3_show,unit:e.field_3_unit,fontsize:parseFloat(e.field_3_fontsize),fontweight:e.field_3_fontweight,position:e.field_3_position,fontcolor:e.field_3_fontcolor,unit_fontsize:parseFloat(e.field_3_unit_fontsize),unit_fontweight:e.field_3_unit_fontweight,unit_fontcolor:e.field_3_unit_fontcolor}],a=(e,t)=>e.show?html`
      ...
      `:html``,s=parseFloat(e.needle_morph),o=parseFloat(e.needle_curve),n=parseFloat(e.needle_position),d=this._buildNeedlePath(s,o,e.needle_invert,n),{minX:r,minY:c,maxX:_,maxY:h}=d.bounds,g=`${r} ${c} ${_-r} ${h-c}`,p=e.needle_invert?e.needle_color_2:e.needle_color_1,f=e.needle_invert?100-parseFloat(e.needle_color_2_pos):parseFloat(e.needle_color_1_pos),u=e.needle_invert?e.needle_color_1:e.needle_color_2,m=e.needle_invert?100-parseFloat(e.needle_color_1_pos):parseFloat(e.needle_color_2_pos);return html`
      <ha-card>
        ${e.header_show?html`
              ...
              <svg class="compass-needle"
                ...
                ${e.needle_image_show&&this._needleImageUrl?svg`
                  <image
                    ...
                    x="${r}" y="${c}"
                    width="${_-r}" height="${h-c}"
                    preserveAspectRatio="xMidYMid slice"
                    clip-path="url(#needleClip)"
                    transform="translate(${(_+r)/2}, ${(h+c)/2}) rotate(${e.needle_image_rotate}) scale(${e.needle_image_scale/100}) translate(${e.needle_image_x}, ${e.needle_image_y}) translate(${-(_+r)/2}, ${-(h+c)/2})"
                  />
                `:svg`
                  <path d="${d.path}" fill="url(#needleGradient)" />
                `}
              </svg>
            `:""}
          </div>
