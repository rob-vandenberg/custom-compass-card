...
const DEFAULT_CONFIG = {
  ...
  tick_large_length:      8,
  tick_large_width:       4,
  tick_large_color:       '#FFFFFF',
  tick_large_position:    0,
  tick_large_cardinals:   false,
  tick_medium_show:       true,
  tick_medium_length:     6,
  tick_medium_width:      1.5,
  tick_medium_color:      '#CCCCCC',
  tick_medium_position:   0,
  tick_small_show:        true,
  tick_small_length:      4,
  tick_small_width:       1,
  tick_small_color:       '#AAAAAA',
  tick_small_position:    0,
};
